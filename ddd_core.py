...
def run_ddd():
    ...
    def draw_info_panel(frame, text, color=(0,255,0)):
        overlay = frame.copy()
        cv2.rectangle(overlay, (20, 20), (470, 100), (0,0,0), -1)
    ...
    def detect_distraction(rot_x, rot_y,avg_EAR,phone_detected):
    ...
    def time_based_check(state):
        nonlocal distraction_start, is_distracted
    ...
    def detect_phone(frame):
        ...
        results = phone_model.predict(frame, conf=0.45, iou=0.45, verbose=False)
    ...
    events_log = open(log_path, mode="w", newline="")
    ...
    while True:
        ...
        if results.multi_face_landmarks:
            for lm in results.multi_face_landmarks:
                ...
                driver_state = detect_distraction(rot_x, rot_y,avg_EAR,phone_detected)
